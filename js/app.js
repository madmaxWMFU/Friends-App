...
const allGender = document.querySelector('#all');
...
const applyFilters = () => {
    Object.keys(listOfFilters).forEach((filter) => {
        allFriends.changeList = listOfFilters[filter](allFriends.changeList, searchValues);
    });
}
